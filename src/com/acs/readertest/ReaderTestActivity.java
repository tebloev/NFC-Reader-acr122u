...
public class ReaderTestActivity extends Activity {
    ...
    public class TransmitTask extends
        ...
        protected Void doInBackground(TransmitParams... params) {
           ...
           // byte[] command = { 0x00, (byte) 0x84, 0x00, 0x00, 0x08 };
            ...
            int foundIndex;
            int startIndex = 0;
            params[0].commandString =  mCommandEditText.getText().toString();
            do {
        ...
        @Override
		  protected void onPostExecute(Void result) {
        	//String aa = NfcUtils.convertBinToASCII(a);
        	//String bb = NfcUtils.convertBinToASCII(a);
        	//Toast.makeText(ReaderTestActivity.this, aa, Toast.LENGTH_LONG).show();
        	//Toast.makeText(ReaderTestActivity.this, bb, Toast.LENGTH_LONG).show();
        	if (a != null && b != null)
        	{
	        	//logMsg(a.toString());
	        	//logMsg(b.toString());
            ...
            public void onClick(View v) {
               ...
               // mOpenButton.setEnabled(false);
                ...
                if (deviceName != null) {
                    ...
                    //Intent intent = new Intent(ReaderTestActivity.this, Login.class);
    ...
    private String toHexString(byte[] buffer) {
       ...
       // Toast.makeText(this,bufferString , Toast.LENGTH_LONG).show();
        return bufferString;
    }
}
